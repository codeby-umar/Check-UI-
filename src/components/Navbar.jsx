  ...
  return (
    <div className="w-87 sticky top-0 h-screen bg-[#0a0a0a] border-r border-white/5 flex flex-col p-8 z-50">
      ...
      <div className="mb-16">
        ...
        >
          <span className="text-[#B23DEB] drop-shadow-[0_0_8px_rgba(178,61,235,0.4)] transition-all group-hover:drop-shadow-[0_0_15px_rgba(178,61,235,0.6)]">
            Check
          </span>{" "}
          UI
        </NavLink>
      ...
      <nav className="flex-grow overflow-y-auto no-scrollbar">
        <ul className="space-y-2">
          ...
          <NavItem
            to="/tests"
            icon={<RiPencilFill size="27" />}
            label="Tests"
          />
          <NavItem
            to="/courses"
            icon={<HiClipboardDocumentList size="27" />}
            label="Courses"
          />
          <NavItem
            to="/profile"
            icon={<IoChatbubbles size="27" />}
            label="Live Chat"
          />
          <NavItem
            to="/leaderboard"
      ...
      <div className="pt-9 border-t border-white/5 space-y-2">
        <p className="text-[10px] font-black text-gray-600 uppercase tracking-[0.2em] mb-4">
          Account
        </p>
        <NavItem
          to="/setting"
